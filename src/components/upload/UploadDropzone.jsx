...
import Button from "../ui/Button"; // or your local Button
...
export default function UploadDropzone({ disabled, onFiles }) {
  ...
  return (
    <div
      ...
      className={`rounded-2xl p-10 text-center transition border-2 border-dashed ${dragOver ? "border-emerald-500 bg-emerald-50/70 shadow-inner" : "border-slate-300 hover:border-emerald-300"}`}
    >
